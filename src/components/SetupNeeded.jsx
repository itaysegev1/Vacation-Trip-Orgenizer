...
const STEPS = [
  ...
  'Authentication → Sign-in method → הפעילו Email/Password, והוסיפו 2 משתמשים (איתי ואיתן).',
  'Firestore Database → Create database (production mode).',
  'עדכנו את שתי כתובות האימייל בקובץ firestore.rules ופרסמו עם firebase deploy.',
    ...
    <div className="relative grid min-h-dvh place-items-center px-6 py-10">
      ...
      <div className="relative z-10 w-full max-w-md rounded-[2rem] bg-white/85 p-7 shadow-2xl backdrop-blur">
        ...
        <p className="mt-1 text-center text-sm text-ink-soft">
          צריך לחבר את Firebase כדי שהאפליקציה תסתנכרן בין שני הטלפונים. זה לוקח כ־5 דקות וחינמי לגמרי.
        </p>
